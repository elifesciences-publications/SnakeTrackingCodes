function test_GUI_V4_Fully_Coded()
...
if ispc()
  gui_Tr.t_Box_Input_1 = uicontrol('Parent', gui_Tr.ui_Box_1, 'Style', 'edit', 'units', 'normalized', 'BackgroundColor','white',  ...
    ...
    'H:\Dropbox\projects\bioestimation\Animals\data\snake\1503_dry', ...
...
hold on
gui_Tr.markers_Forward_Spine         = plot(nan, nan,'r');
gui_Tr.markers_Count_Forward_Spine   = plot(nan, nan,'ro','MarkerSize',15);
